...
class SilverChimpSubscriptionPage_Controller extends Page_Controller {
	...
	function SubscribeAction($raw_data, $form) {
		...
		$result = $this->api->listSubscribe(
				$this->ListID, $postedVars['EMAIL'], $postedVars, SilverChimpSettings::$email_type, SilverChimpSettings::$double_opt_in, $this->AllowUpdateExisting, SilverChimpSettings::$replace_groups, SilverChimpSettings::$send_welcome
		);
